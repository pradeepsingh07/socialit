...
<section id="whatwedo" class="ptb">    
     ...
     <div class="container-fluid res-container">
           <div class="row mx-md-3 mx-lg-3"> 
               ...
               <x-servicecard href="#" title="search engine optimization" image="images/service/gd.webp"/>
               <x-servicecard href="#" title="branding & advertising" image="images/service/gd.webp"/>
           </div>
     </div>
</section>
...
<section id="customer-review" class="ptb">
     <div class="container-fluid res-container">
          <h5 class="font-size-heading">What Our Customers Say</h5>
          <div class="row mx-md-3 mx-lg-3">
          <div class="reviews">
              <x-reviewcard/>
              <x-reviewcard/> 
